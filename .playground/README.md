...
Run `npm run test:agents` to execute the registered test for every playground
agent. Test reports include their session IDs, and each full log is written to
